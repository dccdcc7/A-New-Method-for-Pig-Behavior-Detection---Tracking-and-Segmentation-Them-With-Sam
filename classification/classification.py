...
class Classification(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'F:\pycharmproject\segment-anything\classification\logs\\best_epoch_weights.pth',
        "classes_path"      : 'F:\pycharmproject\segment-anything\classification\model_data\\cls_classes.txt',
        #--------------------------------------------------------------------#
        #   输入的图片大小
        #--------------------------------------------------------------------#
        "input_shape"       : [48, 48],
